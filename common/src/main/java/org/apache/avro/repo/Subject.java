...
public abstract class Subject {
  ...
  /**
   * Create a {@link Subject} that validates schemas with the {@link Validator}
   * provided.
   */
  public static Subject validateWith(Subject subject, Validator validator) {
    if (null == subject || null == validator) {
      return subject;
    } else {
      return new ValidatingSubject(subject, validator);
    }
  }
